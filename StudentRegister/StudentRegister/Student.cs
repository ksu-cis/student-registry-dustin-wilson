...
namespace StudentRegister
{
    ...
    public class Student : INotifyPropertyChanged
    {
        ...
        private void NotifyPropertyChange(string s)
        {
        ...
        {
            this.courseHistory.Add(
                new CourseResult(name, hours, grade, semester));
            NotifyPropertyChange("GPA");
        }
    }
}
